# -*- coding: utf-8 -*-
"""
Created on Tue Sep 23 13:17:11 2025
...
loader = DataSource(
    provider_name="GLODAP_CSV",
    data_format="csv",
    dirin=Path(PROVIDERS_CONFIG["GLODAP_CSV"]["PATH"]),
    data_category=PROVIDERS_CONFIG["GLODAP_CSV"]["CATEGORY"],
    excluded_files=PROVIDERS_CONFIG["GLODAP_CSV"]["EXCLUDE"],
    files_pattern=FileNamePattern("GLODAPv2\..*_all\.csv"), 
