...
loader = DataSource(
    ...
    files_pattern=FileNamePattern("ices_marine_data_{years}.csv"),
    variable_ensemble=SourceVariableSet(
        ...
        chlorophyll=VARS["chlorophyll"].in_file_as("Chlorophyll a").remove_when_all_nan(),
    ),
    read_params={
        "low_memory": False,
        "skiprows": [1],
